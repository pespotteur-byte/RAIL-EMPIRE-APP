# Rail Empire — Registre RC14

**83 dossiers historiques clos sur 87 (95,4 %), deux partiels et deux ouverts : inchangé par rapport à RC13.** La présente passe vise le stockage ; elle ne clôture pas LM03, TIME05, DDS03 ou DDS04. Les preuves des anciennes clôtures restent historiques.

## Optimisations RC14 — hors pourcentage historique
...
| Édition LIGHT | Même contenu runtime après décompression ; sources/historique séparés dans COMPLETE |
...
| ID | Famille | Anomalie | RC12 | RC13 | Preuve ou limite |
|---|---|---|---|---|---|
...
| LM03 | LiveMap / mouvement | Blocage durable vers 12 km/h après changement de page, observé par le joueur | Partiel | Partiel | Toujours partiel : la sauvegarde du joueur n’a pas été reproduite. RC12 corrige des fausses détections de face-à-face et ajoute un instantané local (vitesses, autorité, géométrie courante, temps LOD). Les 600 trains synthétiques avancent dans les essais, sans déduire que le blocage durable vers 12 km/h est résolu. |
...
Voir `RE_REPARATION_RC14_RAPPORT.md` et `QA/RE_REPAIR_RC14/SUMMARY.json`. Les anciennes clôtures restent historiques. Les quatre dossiers ouverts/partiels et le refus OSM ne sont pas résolus par cette optimisation.
