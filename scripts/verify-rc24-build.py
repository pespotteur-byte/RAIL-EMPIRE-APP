...
root=Path(__file__).resolve().parents[1];out=root/'QA/RE_REPAIR_RC24';clean=root.parent/'RE_RC24_INDEPENDENT_BUILD'
...
assets=[];assetdiff=[]
with zipfile.ZipFile(root.parent/'Rail_Empire_S3_GAMEPLAY_REPAIR_RC23.zip') as z:
