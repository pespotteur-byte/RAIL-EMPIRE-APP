import { SimulationEngine } from './engine.js?v=1784931685';
import { startDedensenBenchmark } from './benchmark.js?v=1784931685';
import { SeededRng, setGlobalRng } from './rng.js?v=1784931685';
import { World, createDefaultWorld } from './world.js?v=1784931685';
import { Renderer } from './renderer.js?v=1784931685';
import { UI } from './ui.js?v=1784931685';
import { Economy } from './economy.js?v=1784931685';
import { IncidentManager } from './incidents.js?v=1784931685';
import { FreightManager } from './freight.js?v=1784931685';
import { ScheduleManager } from './schedule.js?v=1784931685';
import { GameStorage } from './storage.js?v=1784931685';
import { LiveryManager } from './livery-manager.js?v=1784931685';
import { AccountManager } from './account.js?v=1784931685';
import { RollingStockManager } from './rolling-stock.js?v=1784931685';
import { RameManager } from './rame.js?v=1784931685';
import { ScheduleCreator, cantonManager } from './schedule-creator.js?v=1784931685';
import { DepotManager } from './depot.js?v=1784931685';
import { WorksManager } from './works.js?v=1784931685';
import { ORMClient } from './orm.js?v=1784931685';
import { LineManager, PlatformManager } from './line.js?v=1784931685';
import { SillonManager } from './sillon.js?v=1784931685';
import { VoiePointManager } from './voie-points.js?v=1784931685';
import { Dashboard } from './dashboard.js?v=1784931685';
import { GraphMarche } from './graph-marche.js?v=1784931685';
import { StaffManager } from './staff.js?v=1784931685';
import { Tutorial } from './tutorial.js?v=1784931685';
import { Bank } from './bank.js?v=1784931685';
import { Weather } from './weather.js?v=1784931685';
import { Unions } from './unions.js?v=1784931685';
import { SeasonalSchedule } from './seasonal.js?v=1784931685';
import { Connections } from './connections.js?v=1784931685';
import { StationUpgrades } from './station-upgrades.js?v=1784931685';
import { A12Model } from './a12-model.js?v=1784931685';
import { JunctionManager } from './junctions.js?v=1784931685';
import { CargoTypeManager } from './cargo-types.js?v=1784931685';
import { ITEModules } from './ite-modules.js?v=1784931685';
import { IndustrialClients } from './industrial-clients.js?v=1784931685';
import { ShuntingManager } from './shunting.js?v=1784931685';
import { haversineDistance } from './simulation.js?v=1784931685';
import { CATALOG, CATALOG_CARGO_TYPES } from './catalog-data.js?v=1784931685';
import { CATALOG_PACK_RE } from './catalog-data-pack-re.js?v=1784931685';
import { adminSync } from './admin-sync.js?v=1784931685';
import { alertToast } from './html-utils.js?v=1784931685';
...
class RailEmpire {
  constructor() {
    ...
    this.liveryManager = new LiveryManager(this.storage);
  ...
  async startGame(savedState) {
    ...
    if (benchmarkParams.get('benchmark') === 'dedensen') {
      ...
      const noIncidents = benchmarkParams.get('no_incidents') === '1' || benchmarkParams.get('no_incidents') === 'true';
      startDedensenBenchmark(this, { total: bTotal, noIncidents });
    }
  ...
  moveTick(dt, timeOfDay) {
    ...
    const SERVICE_GRID_CELL = 0.01; // ~1.1 km
    ...
    for (let i = mediumPhase; i < mediumList.length; i += MEDIUM_INTERVAL) {
      mediumList[i].moveMacro(macroDtMedium, timeOfDay, this.economy, activeServices);
    }

    const macroDtLow = dt * LOW_INTERVAL;
    for (let i = lowPhase; i < lowList.length; i += LOW_INTERVAL) {
      lowList[i].moveMacro(macroDtLow, timeOfDay, this.economy, activeServices);
    }
